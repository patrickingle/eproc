...
<div id="wide" style="float: left; margin-left: 20px; width: 950px; font-size: 10pt;">
	<p style="font-size: 11pt; color: #df0000; margin-top: 17px;">
        ...
        <strong>2 Sampul - Belum Dibuat</strong>
    </p>
    <p style="margin-top: 10px; font-size: 11pt">
    	Berikut adalah daftar 2 sampul yang belum dibuat sebelumnya:
	</p>
    <p style="margin-top: 10px; font-size: 11pt">
    	<table border="0" cellpadding="0" cellspacing="0" width="60%">
            ...
            <tr bgcolor="#ddd">
                ...
                <td valign="top" align="center" style="padding: 5px;"><a href="?mod=eproc&act=tender-approval&mode=app&step=3&tender_id={$s1list[s1].tender_id}&tender_type={$s1list[s1].tender_type}&go=2sampul">BUAT SAMPUL</a></td>
            </tr>
            {/section}
        </table>
	</p>
    <!--<p style="font-size: 11pt; color: #df0000; margin-top: 17px;">
        <img src="{$templateDir}/images/blt1.jpg" align="top" alt="" />
        <strong>2 Sampul - Telah Dibuat</strong>
    </p>
    <p style="margin-top: 10px; font-size: 11pt">
    	Berikut adalah daftar 2 sampul yang telah dibuat sebelumnya:
	</p>
    <p style="margin-top: 10px; font-size: 11pt">
    	<table border="0" cellpadding="0" cellspacing="0" width="60%">
        	<tr bgcolor="#777">
            ...
            <tr bgcolor="#ddd">
                ...
                <td valign="top" align="center" style="padding: 5px;"><a href="?mod=eproc&act=tender-approval&mode=app&step=3&tender_id={$ys1list[ys1].tender_id}&tender_type={$ys1list[ys1].tender_type}&go=2sampul-complete">VIEW</a></td>
            </tr>
            {/section}
        </table>
    </p>-->
