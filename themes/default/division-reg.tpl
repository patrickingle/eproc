...
<div class="cont" style="float: left;">
    ...
    <div class="left25 clear" style="margin-bottom: 10px; width: 700px;">
        <p style="font-size: 11pt; color: #df0000; margin-top: 17px;">
            ...
            <strong>Form Pendaftaran Division User</strong>
        </p>
        <p style="font-size: 11pt; color:black; margin-top: 7px;">
        	<br />&nbsp;<br />
            <form name="divuserReg" action="?mod=divuser&act=reg&step=1" method="post">
            <table width="90%" border="0" cellpadding="1" cellspacing="5">
                ...
                <tr>
                    ...
                    <td width="5%" valign="top"><div align="center">:</div></td>
                    <td width="74%" valign="top">
                    	<input type="text" class="textField" name="cabang" value="{$pCabang}" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="5%" valign="top"><div align="center">:</div></td>
                    <td width="74%" valign="top">
                    	<input type="text" class="textField" name="divisi" value="{$pDivisi}" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="21%" valign="top" style="font-size: 10pt;">&nbsp;</td>
                    <td width="5%" valign="top">&nbsp;</td>
                    <td width="74%" valign="top"><input type="submit" name="submitDivReg" value=" DAFTARKAN " class="textField" /></td>
                </tr>
			</table>
            </form>
