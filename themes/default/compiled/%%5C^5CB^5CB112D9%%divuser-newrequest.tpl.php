<?php /* Smarty version 2.6.18, created on 2008-05-30 16:02:33
         compiled from divuser-newrequest.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'dhtml_calendar', 'divuser-newrequest.tpl', 158, false),)), $this); ?>
            ...
            <td colspan="6" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top" class="tdBorder" style="border-top: 0; border-right: 0;" align="center">
                    ...
                    <img id="cal_req_date1" alt="" src="<?php echo $this->_tpl_vars['templateDir']; ?>
/images/cal.png" />                </td>
                <td valign="top" class="tdBorder" style="border-top: 0; border-right: 0;" align="center">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
        	<td valign="top" width="50%"><center><?php echo $this->_tpl_vars['_fullName']; ?>
</center></td>
    ...
    <div id="calInit">
	    <?php echo smarty_function_dhtml_calendar(array('inputField' => 'req_date1','ifFormat' => "%d %B %Y",'button' => 'cal_req_date1','singleClick' => false), $this);?>
    ...
    <script language="javascript">
		templateDir = '<?php echo $this->_tpl_vars['templateDir']; ?>
';
	</script>
    <?php echo '
    <script language="javascript">
